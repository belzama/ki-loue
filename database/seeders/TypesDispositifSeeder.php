    ...
    public function run(): void
    {
        ...
        $types = [
            ...
            'Auxiliaires de chantier' => [
                ...
                ['nom' => 'Pilonneuse / Dame sauteuse', 'min' => 10000, 'max' => 100000, 'nom_dispositif_fields' => 'marque,modele'],
            ...
            // ======================
            'Vehicule articulé' => [
                ['nom' => 'Semi-remorque benne', 'min' => 100000, 'max' => 300000, 'nom_dispositif_fields' => 'marque,modele,volume_benne'],
                ['nom' => 'Semi-remorque plateau', 'min' => 100000, 'max' => 300000, 'nom_dispositif_fields' => 'marque,modele,charge_utile'],
                ['nom' => 'Porte-engin', 'min' => 200000, 'max' => 1000000, 'nom_dispositif_fields' => 'marque,modele,charge_utile'],
            ],
            ...
            // ======================
            'Vehicule utilitaire' => [
                ['nom' => 'Pickup', 'min' => 15000, 'max' => 50000, 'nom_dispositif_fields' => 'marque,modele'],
                ['nom' => 'Citadine', 'min' => 8000, 'max' => 25000, 'nom_dispositif_fields' => 'marque,modele'],
                ['nom' => 'Berline', 'min' => 12000, 'max' => 40000, 'nom_dispositif_fields' => 'marque,modele'],
                ['nom' => 'SUV Crossover', 'min' => 20000, 'max' => 60000, 'nom_dispositif_fields' => 'marque,modele'],
                ['nom' => 'Luxe 4*4', 'min' => 40000, 'max' => 150000, 'nom_dispositif_fields' => 'marque,modele'],
                ['nom' => 'Bus', 'min' => 50000, 'max' => 200000, 'nom_dispositif_fields' => 'marque,modele,nombre_places'],
                ['nom' => 'Fourgon', 'min' => 25000, 'max' => 80000, 'nom_dispositif_fields' => 'marque,modele,volume_utile'],
            ],
        ];
